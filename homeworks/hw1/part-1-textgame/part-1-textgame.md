...
materials:
    - 
        ...
        url: https://github.com/pearls-lab/deep-rl-course-SP26/tree/main/homeworks/hw1
    - 
...
First download the zip file (or `git clone https://github.com/pearls-lab/deep-rl-course-SP26.git`), then create a virtual environment and install
the dependencies.
