...
title: Convert WikiHow to PDDL (Extra Credit - 20pt)
type: Homework
number: 1-4
active_tab: homework
release_date:
...
7. Discuss how you might use GPT-4 to automatically or semi-automatically convert a wikiHow article to PDDL?
